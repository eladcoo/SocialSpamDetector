...
from rawDataExtractor import extractFromDir, enrichGraphWithContent
from undersample import executeUndersampaling
...
def buildDataGraph(path):
    G = nx.DiGraph()
    content = extractFromDir(path)
    enrichGraphWithContent(G,content)
